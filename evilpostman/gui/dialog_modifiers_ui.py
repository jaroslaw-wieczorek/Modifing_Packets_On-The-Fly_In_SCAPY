...
class Ui_DailogModifiers(object):
    def setupUi(self, DailogModifiers):
        ...
        self.filters_combo_box = QtWidgets.QComboBox(DailogModifiers)
        self.filters_combo_box.setMaximumSize(QtCore.QSize(16777215, 35))
        self.filters_combo_box.setInputMethodHints(QtCore.Qt.ImhHiddenText)
        self.filters_combo_box.setEditable(False)
        self.filters_combo_box.setCurrentText("")
        self.filters_combo_box.setMaxCount(100)
        self.filters_combo_box.setInsertPolicy(QtWidgets.QComboBox.InsertAtCurrent)
        self.filters_combo_box.setSizeAdjustPolicy(QtWidgets.QComboBox.AdjustToMinimumContentsLengthWithIcon)
        self.filters_combo_box.setMinimumContentsLength(2)
        self.filters_combo_box.setFrame(True)
        self.filters_combo_box.setModelColumn(0)
        self.filters_combo_box.setObjectName("filters_combo_box")
        self.filters_combo_box.addItem("")
        self.filters_combo_box.setItemText(0, "")
        self.horizontal_layout.addWidget(self.filters_combo_box)
        ...
        self.filters_combo_box.setCurrentIndex(-1)
