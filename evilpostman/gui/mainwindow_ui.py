...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.filt_button_create_filter = QtWidgets.QPushButton(self.filters_tab)
        self.filt_button_create_filter.setObjectName("filt_button_create_filter")
        self.gridLayout_5.addWidget(self.filt_button_create_filter, 4, 1, 1, 1)
        self.filt_button_back = QtWidgets.QPushButton(self.filters_tab)
        self.filt_button_back.setObjectName("filt_button_back")
        self.gridLayout_5.addWidget(self.filt_button_back, 4, 0, 1, 1)
        self.filt_button_next = QtWidgets.QPushButton(self.filters_tab)
        self.filt_button_next.setObjectName("filt_button_next")
        self.gridLayout_5.addWidget(self.filt_button_next, 4, 2, 1, 1)
        self.filt_list_packets = QtWidgets.QTableWidget(self.filters_tab)
        self.filt_list_packets.setObjectName("filt_list_packets")
        self.filt_list_packets.setColumnCount(3)
        self.filt_list_packets.setRowCount(1)
        item = QtWidgets.QTableWidgetItem()
        item.setTextAlignment(QtCore.Qt.AlignCenter)
        self.filt_list_packets.setVerticalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        item.setTextAlignment(QtCore.Qt.AlignCenter)
        self.filt_list_packets.setHorizontalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        item.setTextAlignment(QtCore.Qt.AlignCenter)
        self.filt_list_packets.setHorizontalHeaderItem(1, item)
        item = QtWidgets.QTableWidgetItem()
        item.setTextAlignment(QtCore.Qt.AlignCenter)
        self.filt_list_packets.setHorizontalHeaderItem(2, item)
        item = QtWidgets.QTableWidgetItem()
        item.setTextAlignment(QtCore.Qt.AlignCenter)
        self.filt_list_packets.setItem(0, 0, item)
        item = QtWidgets.QTableWidgetItem()
        item.setTextAlignment(QtCore.Qt.AlignCenter)
        self.filt_list_packets.setItem(0, 1, item)
        item = QtWidgets.QTableWidgetItem()
        item.setTextAlignment(QtCore.Qt.AlignCenter)
        item.setFlags(QtCore.Qt.ItemIsSelectable|QtCore.Qt.ItemIsUserCheckable|QtCore.Qt.ItemIsEnabled)
        item.setCheckState(QtCore.Qt.Checked)
        self.filt_list_packets.setItem(0, 2, item)
        self.gridLayout_5.addWidget(self.filt_list_packets, 0, 0, 1, 3)
        self.tab_widget.addTab(self.filters_tab, "")
        self.tab = QtWidgets.QWidget()
        self.tab.setObjectName("tab")
        self.verticalLayout = QtWidgets.QVBoxLayout(self.tab)
        self.verticalLayout.setObjectName("verticalLayout")
        self.filt_list_packets_2 = QtWidgets.QTableWidget(self.tab)
        self.filt_list_packets_2.setObjectName("filt_list_packets_2")
        self.filt_list_packets_2.setColumnCount(3)
        self.filt_list_packets_2.setRowCount(1)
        item = QtWidgets.QTableWidgetItem()
        self.filt_list_packets_2.setVerticalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        item.setTextAlignment(QtCore.Qt.AlignCenter)
        self.filt_list_packets_2.setHorizontalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        item.setTextAlignment(QtCore.Qt.AlignCenter)
        self.filt_list_packets_2.setHorizontalHeaderItem(1, item)
        item = QtWidgets.QTableWidgetItem()
        item.setTextAlignment(QtCore.Qt.AlignCenter)
        self.filt_list_packets_2.setHorizontalHeaderItem(2, item)
        item = QtWidgets.QTableWidgetItem()
        self.filt_list_packets_2.setItem(0, 0, item)
        item = QtWidgets.QTableWidgetItem()
        self.filt_list_packets_2.setItem(0, 1, item)
        item = QtWidgets.QTableWidgetItem()
        item.setTextAlignment(QtCore.Qt.AlignCenter)
        item.setFlags(QtCore.Qt.ItemIsUserCheckable|QtCore.Qt.ItemIsEnabled)
        item.setCheckState(QtCore.Qt.Checked)
        self.filt_list_packets_2.setItem(0, 2, item)
        self.verticalLayout.addWidget(self.filt_list_packets_2)
        self.horizontalLayout = QtWidgets.QHBoxLayout()
        self.horizontalLayout.setObjectName("horizontalLayout")
        self.filt_button_back_2 = QtWidgets.QPushButton(self.tab)
        self.filt_button_back_2.setObjectName("filt_button_back_2")
        self.horizontalLayout.addWidget(self.filt_button_back_2)
        self.filt_button_create_filter_2 = QtWidgets.QPushButton(self.tab)
        self.filt_button_create_filter_2.setObjectName("filt_button_create_filter_2")
        self.horizontalLayout.addWidget(self.filt_button_create_filter_2)
        self.filt_button_next_2 = QtWidgets.QPushButton(self.tab)
        self.filt_button_next_2.setObjectName("filt_button_next_2")
        self.horizontalLayout.addWidget(self.filt_button_next_2)
        ...
        self.mod_button_show = QtWidgets.QPushButton(self.modified_tab)
        self.mod_button_show.setObjectName("mod_button_show")
        self.gridLayout_2.addWidget(self.mod_button_show, 1, 1, 1, 1)
        self.mod_button_back = QtWidgets.QPushButton(self.modified_tab)
        self.mod_button_back.setObjectName("mod_button_back")
        self.gridLayout_2.addWidget(self.mod_button_back, 1, 0, 1, 1)
        self.mod_button_stop = QtWidgets.QPushButton(self.modified_tab)
        self.mod_button_stop.setObjectName("mod_button_stop")
        self.gridLayout_2.addWidget(self.mod_button_stop, 1, 2, 1, 1)
        self.mod_list_packets = QtWidgets.QTableWidget(self.modified_tab)
        self.mod_list_packets.setObjectName("mod_list_packets")
        self.mod_list_packets.setColumnCount(1)
        self.mod_list_packets.setRowCount(0)
        item = QtWidgets.QTableWidgetItem()
        self.mod_list_packets.setHorizontalHeaderItem(0, item)
        self.gridLayout_2.addWidget(self.mod_list_packets, 0, 0, 1, 3)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.filt_button_create_filter.setText(_translate("MainWindow", "Utwórz filtr"))
        self.filt_button_back.setText(_translate("MainWindow", "Powrót"))
        self.filt_button_next.setText(_translate("MainWindow", "Dalej"))
        item = self.filt_list_packets.verticalHeaderItem(0)
        item.setText(_translate("MainWindow", "1"))
        item = self.filt_list_packets.horizontalHeaderItem(0)
        item.setText(_translate("MainWindow", "Nazwa filtra"))
        item = self.filt_list_packets.horizontalHeaderItem(1)
        item.setText(_translate("MainWindow", "Filtr"))
        item = self.filt_list_packets.horizontalHeaderItem(2)
        item.setText(_translate("MainWindow", "Włączony"))
        __sortingEnabled = self.filt_list_packets.isSortingEnabled()
        self.filt_list_packets.setSortingEnabled(False)
        item = self.filt_list_packets.item(0, 0)
        item.setText(_translate("MainWindow", "FajowyFiltr"))
        item = self.filt_list_packets.item(0, 1)
        item.setText(_translate("MainWindow", "TCP.src=5000"))
        self.filt_list_packets.setSortingEnabled(__sortingEnabled)
        self.tab_widget.setTabText(self.tab_widget.indexOf(self.filters_tab), _translate("MainWindow", "Filtry"))
        item = self.filt_list_packets_2.verticalHeaderItem(0)
        item.setText(_translate("MainWindow", "1"))
        item = self.filt_list_packets_2.horizontalHeaderItem(0)
        item.setText(_translate("MainWindow", "Nazwa modyfikatora"))
        item = self.filt_list_packets_2.horizontalHeaderItem(1)
        item.setText(_translate("MainWindow", "Przypisany filtr"))
        item = self.filt_list_packets_2.horizontalHeaderItem(2)
        item.setText(_translate("MainWindow", "Włączony"))
        __sortingEnabled = self.filt_list_packets_2.isSortingEnabled()
        self.filt_list_packets_2.setSortingEnabled(False)
        item = self.filt_list_packets_2.item(0, 0)
        item.setText(_translate("MainWindow", "FajowyFiltr"))
        item = self.filt_list_packets_2.item(0, 1)
        item.setText(_translate("MainWindow", "TCP.src=5000"))
        self.filt_list_packets_2.setSortingEnabled(__sortingEnabled)
        self.filt_button_back_2.setText(_translate("MainWindow", "Powrót"))
        self.filt_button_create_filter_2.setText(_translate("MainWindow", "Utwórz modyfikator"))
        self.filt_button_next_2.setText(_translate("MainWindow", "Dalej"))
        self.tab_widget.setTabText(self.tab_widget.indexOf(self.tab), _translate("MainWindow", "Modyfikatory"))
        self.mod_button_show.setText(_translate("MainWindow", "Pokaż pakiet"))
        self.mod_button_back.setText(_translate("MainWindow", "powrót"))
        self.mod_button_stop.setText(_translate("MainWindow", "Zatrzymaj działanie"))
        item = self.mod_list_packets.horizontalHeaderItem(0)
        item.setText(_translate("MainWindow", "Pakiet"))
