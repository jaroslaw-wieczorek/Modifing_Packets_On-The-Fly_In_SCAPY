...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        item.setText(_translate("MainWindow", "IP.src=192.168.1.100"))
        item = self.filt_list_packets.item(0, 2)
        item.setText(_translate("MainWindow", "True"))
        self.filt_list_packets.setSortingEnabled(__sortingEnabled)
        self.tab_widget.setTabText(self.tab_widget.indexOf(self.filters_tab), _translate("MainWindow", "Filtry i modyfikatory"))
